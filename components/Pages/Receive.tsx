...
export const Receive: React.FC = () => {
  ...
  const handleOpen = (card: SavedCard) => {
    ...
    params.set('tab', 'send');
    params.set('name', card.senderName);
    params.set('type', card.type);
    params.set('message', card.message);
    params.set('color', card.backgroundColor);
    params.set('textColor', card.textColor);
    params.set('font', card.font);
    params.set('border', card.border);
    params.set('effect', card.effect);
    params.set('emoji', card.emoji);
