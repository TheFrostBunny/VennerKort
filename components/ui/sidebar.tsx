...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      className={cn("border-sidebar-border mx-3.5 translate-x-px gap-1 px-2.5 py-0.5 group-data-[collapsible=icon]:hidden flex min-w-0 flex-col group-data-[collapsible=icon]:border-0 border-l", className)}
      {...props}
    />
  )
}
